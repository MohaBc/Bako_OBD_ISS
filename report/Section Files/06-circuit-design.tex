...
The ESP32 UART1 (GPIO 16/17) connects to the SIM7670E module through resistors R7--R10, which form a 2~k$\Omega$ voltage divider on each line to shift the 3.3~V ESP32 logic down to the 1.8~V interface level required by the SIM7670E. LEDs D2 and D5, connected through current-limiting resistors, provide visual indication of firmware operating state: D2 pulses on each CAN frame received, and D5 lights during an active GPRS transmission.
...
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-esp32.png}
...
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-mcp2515.png}
...
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-tja1051.png}
...
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-sim7670e.png}
    \caption{SIM7670E LTE Cat-M1 module. Provides 4G cellular connectivity to the VPS cloud backend via GPRS/LTE.}
    \label{fig:photo-sim7670e}
\end{minipage}\hfill
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-ds18b20.png}
...
\begin{minipage}[t]{0.30\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-acs712.png}
...
\begin{minipage}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/component-lm2596.png}
    \caption{LM2596S-ADJ adjustable buck regulator. Steps down the 12~V vehicle supply to the 3.3~V and 5~V board rails.}
    \label{fig:photo-lm2596}
\end{minipage}\hfill
\begin{minipage}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/pcb-assembled.png}
    \caption{Assembled ISS PCB prototype (Rev.~RECTIFICATION\_2). All major components soldered and board ready for initial power-on testing.}
    \label{fig:photo-pcb-assembled}
\end{minipage}
\end{figure}
